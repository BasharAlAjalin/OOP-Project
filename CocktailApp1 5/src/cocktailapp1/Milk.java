...
public class Milk implements Ingredients {
 ...
 private double volume;
    ...
    public Milk(String name,Color color , double volume, double nomberOfCalories) {
        this.name = name;
        this.color = color;
        this.volume = volume;
    ...
    public String getInfo() {
        return "Milk{" + "name=" + name + ", color=" + color + ", nomberOfCalories=" + nomberOfCalories + ", volume=" + volume + '}';
    }   
}
